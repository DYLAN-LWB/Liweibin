...
- (void)viewDidLoad {
    ...
    self.view.backgroundColor = WBBackgroundColor;
    
    //添加自定义nav视图
    self.navigationView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, NAV_H)];
    self.navigationView.backgroundColor = WBDefaultColor;
    [self.view addSubview:self.navigationView];

    //添加标题
    self.navTitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(WBFit(100), NAV_H-44, SCREEN_WIDTH-WBFit(200), 44)];
    ...
    //添加返回按钮
    self.navBackButton = [[UIButton alloc] initWithFrame:CGRectMake(0, NAV_H-44, 50, 40)];
...
- (void)viewWillLayoutSubviews {
    self.navigationView.frame = CGRectMake(0, 0, SCREEN_WIDTH, NAV_H);
    self.navTitleLabel.frame = CGRectMake(WBFit(100), NAV_H-44, SCREEN_WIDTH-WBFit(200), 44);
}
