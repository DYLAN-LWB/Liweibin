...
- (void)showViewController:(NSInteger)index {
    ...
    if([self.delegate respondsToSelector:@selector(WBTabBar:didSelectViewController:)]) {
        [self.delegate WBTabBar:self didSelectViewController:self.viewControllers[index]];
    }
}
